...
import StepIndicate from './StepIndicate'
import StepPostSell from './StepPostSell'
...
const steps = [
  ...
  },
  {
    title: 'Indicação',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="nonzero" className="bi bi-share" viewBox="0 0 16 16">
  ...
  },
  {
    title: 'Pós Venda',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="nonzero" className="bi bi-headset" viewBox="0 0 16 16">
  ...
  return (
    <Card>
      <CardContent sx={{ py: 5.375 }}>
        <StepperWrapper>
          <Stepper activeStep={activeStep} connector={ <div style={{minHeight: '100%', display: 'flex', alignItems: 'center'}}><IconifyIcon icon='mdi:chevron-right' /></div>}>
            {steps.map((step, index) => {
              return (
                <Step key={index} onClick={() => setActiveStep(index)}>
                  <StepLabel icon={<></>} sx={{height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                    <div>
